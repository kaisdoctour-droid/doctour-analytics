...
export const LEAD_STATUS_MAP = {
  'NEW': 'Lead', 'IN_PROCESS': 'En traitement', 'PROCESSED': 'Traité',
  'CONVERTED': 'Converti', 'JUNK': 'Mauvais prospect',
  '1': 'Lead', '2': 'Lead FR', '3': 'Lead IT', '4': 'Tentative de contact',
  '5': 'Attente Questionnaire', '6': 'Attente Photos', '7': 'Attente Indication'
};

export const DEAL_STAGE_MAP = {
  'NEW': 'Nouvelle Transaction', 'PREPARATION': 'Devis sur indications',
  'PREPAYMENT_INVOICE': 'Devis signé', 'EXECUTING': 'Billet Avion Reçu',
  'FINAL_INVOICE': 'Avance Reçu', 'WON': 'Transaction gagnée', 'LOSE': 'Transaction perdue',
  'APOLOGY': 'Avance expirée',
  'C1:NEW': 'Nouvelle Transaction', 'C1:PREPARATION': 'Devis sur indications',
  'C1:PREPAYMENT_INVOICE': 'Devis signé', 'C1:EXECUTING': 'Billet Avion Reçu',
  'C1:FINAL_INVOICE': 'Avance Reçu', 'C1:WON': 'Transaction gagnée', 'C1:LOSE': 'Transaction perdue',
  'C1:APOLOGY': 'Avance expirée',
  'C2:NEW': 'Nouvelle Transaction', 'C2:PREPARATION': 'Devis sur indications',
  'C2:PREPAYMENT_INVOICE': 'Devis signé', 'C2:EXECUTING': 'Billet Avion Reçu',
  'C2:FINAL_INVOICE': 'Avance Reçu', 'C2:WON': 'Transaction gagnée', 'C2:LOSE': 'Transaction perdue',
  'C2:APOLOGY': 'Avance expirée'
};

export const ACTIVITY_TYPE_MAP = {
  '1': 'Rendez-vous', '2': 'Appel', '3': 'Tâche', '4': 'Email', '6': 'SMS'
};
